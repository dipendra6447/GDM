    ...
    <>
      <div className="dashboard-header">
        ...
        <div className="d-flex align-items-center gap-3">
          ...
          <button className="dashboard-profile-btn">
            {data?.user?.avatarUrl ? (
               <img src={data.user.avatarUrl} alt="Avatar" className="dash-avatar" />
            ) : (
      ...
      <div className="dash-top-grid">
        <div className="dash-stats-grid">
          ...
          <StatCard 
            title="Profile View" 
            value={data?.stats?.profileCompletion || 0} // Placeholder mapping
            icon="bi-person" 
            colorScheme="green" 
          />
          <StatCard 
        ...
        <div className="dash-user-card">
          <div className="dash-user-header">
            <div className="dash-user-info">
              {data?.user?.avatarUrl ? (
                <img src={data.user.avatarUrl} alt="Avatar" className="avatar" />
              ) : (
